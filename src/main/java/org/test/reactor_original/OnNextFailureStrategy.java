...
interface OnNextFailureStrategy extends BiFunction<Throwable, Object, Throwable>,
	...
	default Throwable apply(Throwable throwable,  Object o) {
		return process(throwable, o, Context.empty());
	}

	@Override
	boolean test(Throwable throwable,  Object o);
	...
	Throwable process(Throwable error,  Object value, Context context);
	...
	OnNextFailureStrategy STOP = new OnNextFailureStrategy() {
		...
		@Override
		public boolean test(Throwable error,  Object value) {
			return false;
		}

		@Override
		public Throwable process(Throwable error,  Object value, Context context) {
	...
	final class LambdaOnNextErrorStrategy implements OnNextFailureStrategy {
		...
		public Throwable process(Throwable error,  Object value, Context ignored) {
