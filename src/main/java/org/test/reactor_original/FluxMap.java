...
import org.test.reactor_original.Fuseable.ConditionalSubscriber;
...
final class FluxMap<T, R> extends InternalFluxOperator<T, R> {
	...
	public CoreSubscriber<? super T> subscribeOrReturn(CoreSubscriber<? super R> actual) {
		if (actual instanceof ConditionalSubscriber) {
			ConditionalSubscriber<? super R> cs =
					(ConditionalSubscriber<? super R>) actual;
	...
	static final class MapConditionalSubscriber<T, R>
		...
		MapConditionalSubscriber(ConditionalSubscriber<? super R> actual,
				Function<? super T, ? extends R> mapper) {
			this.actual = actual;
			this.mapper = mapper;
		}
