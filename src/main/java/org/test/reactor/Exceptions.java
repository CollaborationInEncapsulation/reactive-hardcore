...
import org.test.reactor.retry.Retry;
...
public abstract class Exceptions {
	 ...
	 */
	public static RuntimeException retryExhausted(String message,  Throwable cause) {
	 ...
	 */
	public static boolean isMultiple( Throwable t) {
	 ...
	 */
	public static boolean isRetryExhausted( Throwable t) {
	 ...
	 */
	public static boolean isTraceback( Throwable t) {
		if (t == null) {
			return false;
		}
		//FIXME maybe add an interface here for detection purposes
		return "publisher.FluxOnAssembly.OnAssemblyException".equals(t.getClass().getCanonicalName());
	}
	 ...
	 */
	public static List<Throwable> unwrapMultiple( Throwable potentialMultiple) {
	 ...
	 * empty List.
	 */
	public static List<Throwable> unwrapMultipleExcludingTracebacks( Throwable potentialMultiple) {
		if (potentialMultiple == null) {
			return Collections.emptyList();
		}
