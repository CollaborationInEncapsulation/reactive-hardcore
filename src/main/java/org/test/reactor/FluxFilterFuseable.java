...
final class FluxFilterFuseable<T> extends InternalFluxOperator<T, T> implements Fuseable {
	...
	public int characteristics() {
		return Characteristics.FUSEABLE | Characteristics.OPTIMIZABLE_OPERATOR;
	}
	...
	public CoreSubscriber<? super T> subscribeOrReturn(CoreSubscriber<? super T> actual) {
		...
		if (CoreSubscriber.Characteristics.isConditional(characteristics)) {
			return new FilterFuseableConditionalSubscriber<>((ConditionalSubscriber<? super T>) actual, predicate);
		}
