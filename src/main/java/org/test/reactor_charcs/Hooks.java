...
import org.test.reactor_charcs.FluxOnAssembly.MethodReturnSnapshot;
...
public abstract class Hooks {
	...
	@Deprecated
	public static <T, P extends Publisher<T>> Publisher<T> addReturnInfo( P publisher, String method) {
		if (publisher == null) {
			return null;
		}
