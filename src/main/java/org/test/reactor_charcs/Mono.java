...
//	 ==============================================================================================================
    ...
    public final Flux<T> flux() {
			final int characteristics = this.characteristics();
			if (Characteristics.isCallable(characteristics) && !(Characteristics.isScalar(characteristics))) {
