...
public interface CoreSubscriber<T> extends Subscriber<T> {
	...
	interface Characteristics {
		int CONDITIONAL             = 0b0000_0000_0000_0000_0000_0000_0000_0001;

		static boolean isConditional(int characteristics) {
			return (characteristics & CONDITIONAL) == CONDITIONAL;
		}
	}
}
