...
import org.test.reactor_charcs.FluxOnAssembly.AssemblySnapshot;
import org.test.reactor_charcs.FluxSink.OverflowStrategy;
import org.test.reactor_charcs.concurrent.Queues;
import org.test.reactor_charcs.context.Context;
import org.test.reactor_charcs.function.Tuple2;
import org.test.reactor_charcs.function.Tuples;
...
//	 ==============================================================================================================
	...
	public final Mono<T> next() {
		...
		if(Characteristics.isCallable(characteristics)) {
			...
			return Mono.onAssembly(wrapToMono(m, characteristics));
		}
	...
	public final void subscribe(Subscriber<? super T> actual) {
		...
		try {
			if (Characteristics.isOptimizableOperator(characteristics)) {
