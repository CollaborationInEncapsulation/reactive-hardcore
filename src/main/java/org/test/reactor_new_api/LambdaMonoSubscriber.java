...
import static org.test.reactor_original.Scannable.Attr.RUN_STYLE;
import static org.test.reactor_original.Scannable.Attr.RunStyle.SYNC;
 ...
 */
final class LambdaMonoSubscriber<T> implements InnerConsumer<T>,
    Disposable {
