...
import org.test.reactor_original.CoreSubscriber;
import org.test.reactor_original.Flux;
import org.test.reactor_original.Fuseable;
import org.test.reactor_original.Operators;

/**
 * Streams the characters of a string.
 */
final class FluxCharSequenceOriginal extends Flux<Integer> implements Fuseable {

	final CharSequence string;

	FluxCharSequenceOriginal(CharSequence string) {
		this.string = string;
	}
	...
	static final class CharSequenceSubscription implements QueueSubscription<Integer> {
